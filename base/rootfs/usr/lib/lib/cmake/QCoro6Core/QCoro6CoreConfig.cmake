...
get_filename_component(_realOrig "/usr/lib/cmake/QCoro6Core" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/QCoro6CoreTargets.cmake")

# Versionless target, for compatiblity with Qt6
if (TARGET QCoro6::Core AND NOT TARGET QCoro::Core)
    add_library(QCoro::Core INTERFACE IMPORTED)
    set_target_properties(QCoro::Core PROPERTIES
        INTERFACE_LINK_LIBRARIES "QCoro6::Core"
    )
endif()
