...
set(Qt5Core_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.19"
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.19/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glib;glibc;posix-libiconv;hijricalendar;icu;inotify;journald;linkat;system-pcre2;poll_ppoll;renameat2;sha3-fast;statx;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;gnu-libiconv;iconv;lttng;mimetype-database;poll_poll;poll_pollts;poll_select;slog2;syslog)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.15.19" "" FALSE)
