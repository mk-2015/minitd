...
set(Qt5Gui_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt/QtGui/5.15.19"
        "${_qt5Gui_install_prefix}/include/qt/QtGui/5.15.19/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 xkbcommon;xkbcommon-x11;xcb;accessibility-atspi-bridge;drm_atomic;egl;egl_x11;eglfs;kms;eglfs_egldevice;eglfs_gbm;xlib;xcb-xlib;eglfs_x11;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;imageio-text-loading;jpeg;libinput;libinput-axis-api;linuxfb;mtdev;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;system-xcb-xinput;tslib;tuiotouch;vkgen;vnc;xcb-egl-plugin;xcb-glx-plugin;xcb-glx)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;dxgi1_2;dxguid;eglfs_brcm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;vsp2;eglfs_vsp2;integrityfb;integrityhid;xcb-native-painting;xcb-sm)
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.19" "" FALSE)
