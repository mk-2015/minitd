...
set(Qt5QmlWorkerScript_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/qt/QtQmlWorkerScript/5.15.19"
        "${_qt5QmlWorkerScript_install_prefix}/include/qt/QtQmlWorkerScript/5.15.19/QtQmlWorkerScript"
    )
    ...
    foreach(_module_dep ${_Qt5QmlWorkerScript_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5QmlWorkerScript_FIND_VERSION_EXACT}
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "libQt5QmlWorkerScript.so.5.15.19" "" FALSE)
