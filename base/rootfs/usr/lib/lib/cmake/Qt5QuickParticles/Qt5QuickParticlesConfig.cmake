...
set(Qt5QuickParticles_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::QuickParticles)
    ...
    set(Qt5QuickParticles_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickParticles_install_prefix}/include/qt/QtQuickParticles/5.15.19"
        "${_qt5QuickParticles_install_prefix}/include/qt/QtQuickParticles/5.15.19/QtQuickParticles"
    )
    ...
    foreach(_module_dep ${_Qt5QuickParticles_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5QuickParticles_FIND_VERSION_EXACT}
    ...
    _populate_QuickParticles_target_properties(RELEASE "libQt5QuickParticles.so.5.15.19" "" FALSE)
