...
set(Qt5QuickShapes_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::QuickShapes)
    ...
    set(Qt5QuickShapes_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickShapes_install_prefix}/include/qt/QtQuickShapes/5.15.19"
        "${_qt5QuickShapes_install_prefix}/include/qt/QtQuickShapes/5.15.19/QtQuickShapes"
    )
    ...
    foreach(_module_dep ${_Qt5QuickShapes_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5QuickShapes_FIND_VERSION_EXACT}
    ...
    _populate_QuickShapes_target_properties(RELEASE "libQt5QuickShapes.so.5.15.19" "" FALSE)
