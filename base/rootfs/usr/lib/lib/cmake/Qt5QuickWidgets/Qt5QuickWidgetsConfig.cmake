...
set(Qt5QuickWidgets_VERSION_STRING 5.15.19)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/qt/QtQuickWidgets/5.15.19"
        "${_qt5QuickWidgets_install_prefix}/include/qt/QtQuickWidgets/5.15.19/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.19 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "libQt5QuickWidgets.so.5.15.19" "" FALSE)
