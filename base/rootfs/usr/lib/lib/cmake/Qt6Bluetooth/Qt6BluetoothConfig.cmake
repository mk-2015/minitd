...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6Bluetooth" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6BluetoothTargetsPrecheck.cmake")

if(NOT __qt_Bluetooth_skip_include_targets_file AND Qt6Bluetooth_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6BluetoothExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Bluetooth_targets_file_included ON)
endif()
...
if (Qt6Bluetooth_FOUND
    ...
    find_package(Qt6BluetoothPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Bluetooth_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Bluetooth)
    ...
    if(NOT DEFINED Qt6Bluetooth_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Bluetooth_skip_include_targets_file)
            string(APPEND Qt6Bluetooth_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Bluetooth_skip_include_targets_file being set to TRUE and thus "
