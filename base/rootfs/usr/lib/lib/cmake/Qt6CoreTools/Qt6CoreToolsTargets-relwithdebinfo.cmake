...
set_target_properties(Qt6::syncqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/syncqt"
  )
...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/moc"
  )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/rcc"
  )
...
set_target_properties(Qt6::tracepointgen PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/tracepointgen"
  )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/tracegen"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/cmake_automoc_parser"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/qlalr"
  )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/bin/qtpaths"
  )
...
set_target_properties(Qt6::androiddeployqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/bin/androiddeployqt"
  )
...
set_target_properties(Qt6::androidtestrunner PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/bin/androidtestrunner"
  )
...
set_target_properties(Qt6::wasmdeployqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/bin/wasmdeployqt"
  )

list(APPEND _cmake_import_check_targets Qt6::wasmdeployqt )
list(APPEND _cmake_import_check_files_for_Qt6::wasmdeployqt "${_IMPORT_PREFIX}/lib/qt6/bin/wasmdeployqt" )
...
set_target_properties(Qt6::qmake PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/qt6/bin/qmake"
  )
