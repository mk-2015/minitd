...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6KmsSupportPrivate" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6KmsSupportPrivateTargetsPrecheck.cmake")

if(NOT __qt_KmsSupportPrivate_skip_include_targets_file AND Qt6KmsSupportPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6KmsSupportPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_KmsSupportPrivate_targets_file_included ON)
endif()
...
if (Qt6KmsSupportPrivate_FOUND
    ...
    find_package(Qt6KmsSupportPrivatePrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_KmsSupportPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::KmsSupportPrivate)
    ...
    if(NOT DEFINED Qt6KmsSupportPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_KmsSupportPrivate_skip_include_targets_file)
            string(APPEND Qt6KmsSupportPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_KmsSupportPrivate_skip_include_targets_file being set to TRUE and thus "
