...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6PdfQuick" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfQuickTargetsPrecheck.cmake")

if(NOT __qt_PdfQuick_skip_include_targets_file AND Qt6PdfQuick_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfQuickExtraProperties.cmake"
        OPTIONAL)
    set(__qt_PdfQuick_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_PdfQuick_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfQuick-build.cmake" OPTIONAL)
if (Qt6PdfQuick_FOUND
        AND NOT Qt6PdfQuickPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_PdfQuick_always_load_private_module
    ...
    find_package(Qt6PdfQuickPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6PdfQuickPrivate_FOUND)
        get_property(Qt6PdfQuickPrivate_warning_shown GLOBAL PROPERTY
            Qt6PdfQuickPrivate_warning_shown
        )
        if(NOT Qt6PdfQuickPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6PdfQuickPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6PdfQuickPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_PdfQuick_always_load_private_module)

if(__qt_PdfQuick_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::PdfQuick)
    ...
    if(NOT "PdfQuick" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT DEFINED Qt6PdfQuick_NOT_FOUND_MESSAGE)
        ...
        if(__qt_PdfQuick_skip_include_targets_file)
            string(APPEND Qt6PdfQuick_NOT_FOUND_MESSAGE
                "Possibly due to __qt_PdfQuick_skip_include_targets_file being set to TRUE and thus "
