...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6PdfWidgets" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfWidgetsTargetsPrecheck.cmake")

if(NOT __qt_PdfWidgets_skip_include_targets_file AND Qt6PdfWidgets_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfWidgetsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_PdfWidgets_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_PdfWidgets_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfWidgets-build.cmake" OPTIONAL)
if (Qt6PdfWidgets_FOUND
        AND NOT Qt6PdfWidgetsPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_PdfWidgets_always_load_private_module
    ...
    find_package(Qt6PdfWidgetsPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6PdfWidgetsPrivate_FOUND)
        get_property(Qt6PdfWidgetsPrivate_warning_shown GLOBAL PROPERTY
            Qt6PdfWidgetsPrivate_warning_shown
        )
        if(NOT Qt6PdfWidgetsPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6PdfWidgetsPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6PdfWidgetsPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_PdfWidgets_always_load_private_module)

if(__qt_PdfWidgets_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::PdfWidgets)
    ...
    if(NOT "PdfWidgets" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT DEFINED Qt6PdfWidgets_NOT_FOUND_MESSAGE)
        ...
        if(__qt_PdfWidgets_skip_include_targets_file)
            string(APPEND Qt6PdfWidgets_NOT_FOUND_MESSAGE
                "Possibly due to __qt_PdfWidgets_skip_include_targets_file being set to TRUE and thus "
