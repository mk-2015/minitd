...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6Quick3DAssetImport" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Quick3DAssetImportTargetsPrecheck.cmake")

if(NOT __qt_Quick3DAssetImport_skip_include_targets_file AND Qt6Quick3DAssetImport_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6Quick3DAssetImportExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Quick3DAssetImport_targets_file_included ON)
endif()
...
if (Qt6Quick3DAssetImport_FOUND
    ...
    find_package(Qt6Quick3DAssetImportPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Quick3DAssetImport_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Quick3DAssetImport)
    ...
    if(NOT DEFINED Qt6Quick3DAssetImport_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Quick3DAssetImport_skip_include_targets_file)
            string(APPEND Qt6Quick3DAssetImport_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Quick3DAssetImport_skip_include_targets_file being set to TRUE and thus "
