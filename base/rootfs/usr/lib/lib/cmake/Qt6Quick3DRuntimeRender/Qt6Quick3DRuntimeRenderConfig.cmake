...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6Quick3DRuntimeRender" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6Quick3DRuntimeRenderTargetsPrecheck.cmake")

if(NOT __qt_Quick3DRuntimeRender_skip_include_targets_file AND Qt6Quick3DRuntimeRender_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6Quick3DRuntimeRenderExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Quick3DRuntimeRender_targets_file_included ON)
endif()
...
if (Qt6Quick3DRuntimeRender_FOUND
    ...
    find_package(Qt6Quick3DRuntimeRenderPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Quick3DRuntimeRender_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Quick3DRuntimeRender)
    ...
    if(NOT DEFINED Qt6Quick3DRuntimeRender_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Quick3DRuntimeRender_skip_include_targets_file)
            string(APPEND Qt6Quick3DRuntimeRender_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Quick3DRuntimeRender_skip_include_targets_file being set to TRUE and thus "
