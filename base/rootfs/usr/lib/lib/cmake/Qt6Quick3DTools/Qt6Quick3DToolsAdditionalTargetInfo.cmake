...
get_target_property(_qt_imported_location Qt6::particleshadergen IMPORTED_LOCATION_RELWITHDEBINFO)
get_target_property(_qt_imported_location_default Qt6::particleshadergen IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})

# Import target "Qt6::particleshadergen" for configuration "Release"
set_property(TARGET Qt6::particleshadergen APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)

if(_qt_imported_location)
    set_property(TARGET Qt6::particleshadergen PROPERTY IMPORTED_LOCATION_RELEASE "${_qt_imported_location}")
endif()

# Import target "Qt6::particleshadergen" for configuration "MinSizeRel"
set_property(TARGET Qt6::particleshadergen APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::particleshadergen PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()

# Default configuration
if(_qt_imported_location_default)
    set_property(TARGET Qt6::particleshadergen PROPERTY IMPORTED_LOCATION "${_qt_imported_location_default}")
endif()
