...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6QuickTimelineBlendTrees" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickTimelineBlendTreesTargetsPrecheck.cmake")

if(NOT __qt_QuickTimelineBlendTrees_skip_include_targets_file AND Qt6QuickTimelineBlendTrees_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickTimelineBlendTreesExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QuickTimelineBlendTrees_targets_file_included ON)
endif()
...
if (Qt6QuickTimelineBlendTrees_FOUND
    ...
    find_package(Qt6QuickTimelineBlendTreesPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QuickTimelineBlendTrees_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QuickTimelineBlendTrees)
    ...
    if(NOT DEFINED Qt6QuickTimelineBlendTrees_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QuickTimelineBlendTrees_skip_include_targets_file)
            string(APPEND Qt6QuickTimelineBlendTrees_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QuickTimelineBlendTrees_skip_include_targets_file being set to TRUE and thus "
