...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6Sensors" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SensorsTargetsPrecheck.cmake")

if(NOT __qt_Sensors_skip_include_targets_file AND Qt6Sensors_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SensorsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Sensors_targets_file_included ON)
endif()
...
if (Qt6Sensors_FOUND
    ...
    find_package(Qt6SensorsPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Sensors_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Sensors)
    ...
    if(NOT DEFINED Qt6Sensors_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Sensors_skip_include_targets_file)
            string(APPEND Qt6Sensors_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Sensors_skip_include_targets_file being set to TRUE and thus "
