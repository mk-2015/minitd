...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6SensorsQuick" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SensorsQuickTargetsPrecheck.cmake")

if(NOT __qt_SensorsQuick_skip_include_targets_file AND Qt6SensorsQuick_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SensorsQuickExtraProperties.cmake"
        OPTIONAL)
    set(__qt_SensorsQuick_targets_file_included ON)
endif()
...
if (Qt6SensorsQuick_FOUND
    ...
    find_package(Qt6SensorsQuickPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_SensorsQuick_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::SensorsQuick)
    ...
    if(NOT DEFINED Qt6SensorsQuick_NOT_FOUND_MESSAGE)
        ...
        if(__qt_SensorsQuick_skip_include_targets_file)
            string(APPEND Qt6SensorsQuick_NOT_FOUND_MESSAGE
                "Possibly due to __qt_SensorsQuick_skip_include_targets_file being set to TRUE and thus "
