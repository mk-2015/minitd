...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6WebEngineQuick" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickTargetsPrecheck.cmake")

if(NOT __qt_WebEngineQuick_skip_include_targets_file AND Qt6WebEngineQuick_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickExtraProperties.cmake"
        OPTIONAL)
    set(__qt_WebEngineQuick_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_WebEngineQuick_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuick-build.cmake" OPTIONAL)
if (Qt6WebEngineQuick_FOUND
        AND NOT Qt6WebEngineQuickPrivate_FOUND
        AND NOT FALSE
        AND (
            __qt_WebEngineQuick_always_load_private_module
    ...
    find_package(Qt6WebEngineQuickPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6WebEngineQuickPrivate_FOUND)
        get_property(Qt6WebEngineQuickPrivate_warning_shown GLOBAL PROPERTY
            Qt6WebEngineQuickPrivate_warning_shown
        )
        if(NOT Qt6WebEngineQuickPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6WebEngineQuickPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6WebEngineQuickPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_WebEngineQuick_always_load_private_module)

if(__qt_WebEngineQuick_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::WebEngineQuick)
    ...
    if(NOT "WebEngineQuick" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT DEFINED Qt6WebEngineQuick_NOT_FOUND_MESSAGE)
        ...
        if(__qt_WebEngineQuick_skip_include_targets_file)
            string(APPEND Qt6WebEngineQuick_NOT_FOUND_MESSAGE
                "Possibly due to __qt_WebEngineQuick_skip_include_targets_file being set to TRUE and thus "
