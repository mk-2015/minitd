...
get_filename_component(_realOrig "/usr/lib/cmake/Qt6WebEngineQuickDelegatesQml" REALPATH)
...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickDelegatesQmlTargetsPrecheck.cmake")

if(NOT __qt_WebEngineQuickDelegatesQml_skip_include_targets_file AND Qt6WebEngineQuickDelegatesQml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickDelegatesQmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_WebEngineQuickDelegatesQml_targets_file_included ON)
endif()

# Find the private module counterpart.
set(__qt_WebEngineQuickDelegatesQml_always_load_private_module OFF)
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebEngineQuickDelegatesQml-build.cmake" OPTIONAL)
if (Qt6WebEngineQuickDelegatesQml_FOUND
        AND NOT Qt6WebEngineQuickDelegatesQmlPrivate_FOUND
        AND NOT TRUE
        AND (
            __qt_WebEngineQuickDelegatesQml_always_load_private_module
    ...
    find_package(Qt6WebEngineQuickDelegatesQmlPrivate "6.11.1" EXACT
        QUIET
        CONFIG
        PATHS
    ...
    if(NOT Qt6WebEngineQuickDelegatesQmlPrivate_FOUND)
        get_property(Qt6WebEngineQuickDelegatesQmlPrivate_warning_shown GLOBAL PROPERTY
            Qt6WebEngineQuickDelegatesQmlPrivate_warning_shown
        )
        if(NOT Qt6WebEngineQuickDelegatesQmlPrivate_warning_shown)
            message(VERBOSE
                "The private module package 'Qt6WebEngineQuickDelegatesQmlPrivate' "
                "could not be found. It possibly needs to be installed separately with your "
                "package manager."
            )
            set_property(GLOBAL PROPERTY
                Qt6WebEngineQuickDelegatesQmlPrivate_warning_shown ON
            )
        endif()
    endif()
endif()
unset(__qt_WebEngineQuickDelegatesQml_always_load_private_module)

if(__qt_WebEngineQuickDelegatesQml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::WebEngineQuickDelegatesQml)
    ...
    if(NOT "WebEngineQuickDelegatesQml" IN_LIST QT_ALL_MODULES_FOUND_VIA_FIND_PACKAGE)
    ...
    if(NOT DEFINED Qt6WebEngineQuickDelegatesQml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_WebEngineQuickDelegatesQml_skip_include_targets_file)
            string(APPEND Qt6WebEngineQuickDelegatesQml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_WebEngineQuickDelegatesQml_skip_include_targets_file being set to TRUE and thus "
