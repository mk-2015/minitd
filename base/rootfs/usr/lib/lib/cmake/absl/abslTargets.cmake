...
set_target_properties(absl::hash_generator_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::hash_policy_testing;absl::memory;absl::meta;absl::no_destructor;absl::random_random;absl::strings"
)
...
set_target_properties(absl::unordered_map_constructor_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)
...
set_target_properties(absl::random_mocking_bit_gen PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::fast_type_id;absl::flat_hash_map;absl::raw_logging_internal;absl::random_internal_mock_helpers;absl::random_mocking_access;absl::random_random;absl::type_traits;absl::utility;GTest::gmock;GTest::gtest"
)
...
add_library(absl::status_builder SHARED IMPORTED)
...
set_target_properties(absl::status_matchers PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::base;absl::core_headers;absl::status;absl::statusor;absl::strings;GTest::gmock;GTest::gtest"
)
...
add_library(absl::clock_interface SHARED IMPORTED)
...
# Create imported target absl::simulated_clock
add_library(absl::simulated_clock SHARED IMPORTED)

set_target_properties(absl::simulated_clock PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::clock_interface;absl::time;absl::config;absl::core_headers;absl::nullability;absl::synchronization"
)
...
add_library(absl::source_location SHARED IMPORTED)
