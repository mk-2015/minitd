...
set_target_properties(llhttp::llhttp_shared PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libllhttp.so.9.3.1"
  IMPORTED_SONAME_RELWITHDEBINFO "libllhttp.so.9.3"
  )

list(APPEND _cmake_import_check_targets llhttp::llhttp_shared )
list(APPEND _cmake_import_check_files_for_llhttp::llhttp_shared "${_IMPORT_PREFIX}/lib/libllhttp.so.9.3.1" )
