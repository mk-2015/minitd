...
get_filename_component(_realOrig "/usr/lib/cmake/phonon4qt6" REALPATH)
...
# known at buildtime
set(PHONON_LIB_SONAME "phonon4qt6")
set(PHONON_VERSION 4.12.0)

set(PHONON_PULSESUPPORT TRUE)
set(PHONON_FIND_EXPERIMENTAL ON)
set(PHONON_BACKEND_DIR_SUFFIX phonon4qt6_backend)

# install locations
set(PHONON_INCLUDE_DIR "${PACKAGE_PREFIX_DIR}/include/phonon4qt6")
...
set(PHONON_BUILDSYSTEM_DIR "${PACKAGE_PREFIX_DIR}/share/phonon4qt6/buildsystem/")
...
set(PHONON_LIBRARY Phonon::phonon4qt6)
...
if("${Phonon4Qt6_FIND_COMPONENTS}" MATCHES ".*(Experimental|experimental).*")
    find_package(Phonon4Qt6Experimental ${PHONON_VERSION} EXACT CONFIG REQUIRED
                 PATHS ${CMAKE_CURRENT_LIST_DIR}
                 NO_DEFAULT_PATH)
elseif(PHONON_FIND_EXPERIMENTAL)
    find_package(Phonon4Qt6Experimental ${PHONON_VERSION} EXACT CONFIG QUIET
                 PATHS ${CMAKE_CURRENT_LIST_DIR}
                 NO_DEFAULT_PATH)
endif()
